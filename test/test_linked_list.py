...
from leetcode.linked_list.add_two_numbers import add_two_numbers
...
class TestLinkedList(unittest.TestCase):
    ...
    def test_add_two_numbers(self):
        l1 = SinglyListNode(2)
        l1.next = SinglyListNode(4)
        l1.next.next = SinglyListNode(3)

        l2 = SinglyListNode(5)
        l2.next = SinglyListNode(6)
        l2.next.next = SinglyListNode(4)

        new = add_two_numbers(l1, l2)
        self.assertEqual(7, new.val)
        self.assertEqual(0, new.next.val)
        self.assertEqual(8, new.next.next.val)
